...
Future<void> init() async {
  ...
  getIt.registerLazySingleton<ApiService>(() => ApiService()..configureDio(baseUrl: "http://91.84.122.173:8000/"));
  ...
  getIt.registerLazySingleton<AppVersionService>(() => AppVersionServiceImpl());
}
